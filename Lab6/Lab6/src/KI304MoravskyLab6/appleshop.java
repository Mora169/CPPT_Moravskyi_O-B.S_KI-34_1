...
/**
 * The `appleshop` class represents an item of type Item with a specified name and price.
 */
public class appleshop implements Items {
    private String name;
     ...
     */
    public appleshop(String n, double p) {
        this.name = n;
        this.price = p;
