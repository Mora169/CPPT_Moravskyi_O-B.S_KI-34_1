...
public class Lab2 {
     ...
     */
    public Lab2(String type, String version, int price, int count, boolean isavailable, boolean additional, String additional_devices) {
    ...
    public void clearLogFile() {
        File logFile = new File("lab2.txt");
        try {
    ...
    private void writeToLogFile(String message) {
        try (PrintWriter writer = new PrintWriter(new FileOutputStream(new File("lab2.txt"), true))) {
